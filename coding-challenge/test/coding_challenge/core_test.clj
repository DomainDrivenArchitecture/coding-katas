...
(def solution-1
  [{:name "micha" :distance 20, :time 1.5, :kph 13.333333333333334}
   ...
   {:name "clemens", :distance 65, :time 4, :kph 65/4}
...
(def solution-add-to-data
  [{:name "micha", :distance 20, :time 1.5} 
   ...
   {:name "clemens", :distance 65, :time 4} 
   {:name "clemens", :distance 42, :time 42} 
   {:name "peter", :distance 25, :time 1}
  ;this one got added 
   {:name "lustig", :distance 1, :time 1, :kph 1}])
...
(deftest test-distance-sum-of-meissa-members
  (testing
   (is (= (core/distance-sum-of-meissa-members core/data) 549.5))))

(deftest test-add-to-data
  (testing 
   (is (= (core/add-to-data core/data {:name "lustig" :distance 1 :time 1})
          solution-add-to-data))))
